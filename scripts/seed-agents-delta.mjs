// Mesmo padrão de scripts/seed-agents.mjs — equipe DELTA, unidade CS Feijó.
// Usuário/senha inicial = 6 primeiros dígitos da matrícula.
//
// Uso:
//   SUPABASE_URL="https://xxxx.supabase.co" \
//   SUPABASE_SERVICE_ROLE_KEY="sua-chave-service-role" \
//   node scripts/seed-agents-delta.mjs
...
// Equipe DELTA, Unidade CS Feijó.
const AGENTS = [
  { name: 'Sebastião da Silva Souza', matricula: '96310461', position: 'Agente Socioeducativo', team: 'DELTA' },
  { name: 'André Romero Portela da Silva', matricula: '94023814', position: 'Agente Socioeducativo', team: 'DELTA' },
  { name: 'Marcelo Vasconcelos da Silva', matricula: '9529403', position: 'Agente Socioeducativo', team: 'DELTA' },
  { name: 'Francisco Estevaldo S. Silva', matricula: '96861081', position: 'Agente Socioeducativo', team: 'DELTA' },
  { name: 'Elijunior Parentes dos Santos', matricula: '95280424-2', position: 'Chefe de Equipe', team: 'DELTA' },
];
...
console.log('\nConcluído — equipe DELTA completa.');
