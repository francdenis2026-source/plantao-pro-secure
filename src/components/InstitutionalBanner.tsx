...
import logoOfficialAsset from '@/assets/logo-ise-socioeducativo.webp';
...
const themeConfigs: Record<string, {
  ...
  military: {
    gradient: 'from-primary via-yellow-400 to-primary',
  ...
  sentinel: {
    gradient: 'from-orange-400 via-primary to-yellow-400',
